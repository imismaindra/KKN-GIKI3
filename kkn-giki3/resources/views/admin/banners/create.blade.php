...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div class="lg:col-span-6">
            <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm space-y-6">
                @csrf
                ...
                <div>
                    <label for="image_path" class="block text-sm font-semibold text-slate-700 mb-1">Pilih Gambar Banner</label>
                    ...
                    <p class="text-xs text-slate-400 mt-1">Format gambar (PNG, JPG, JPEG). Maksimal 2MB.</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="button_text" id="button_text" value="{{ old('button_text') }}" placeholder="Contoh: Hubungi Kami"
                            class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
                    ...
                    <div>
                        ...
                        <input type="url" name="button_url" id="button_url" value="{{ old('button_url') }}" placeholder="https://..."
                            class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
        ...
        <div class="lg:col-span-6 lg:sticky lg:top-6">
            <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                <div class="mb-4">
                    ...
                    <p class="text-slate-400 text-xs mt-0.5">Tampilan banner secara langsung saat Anda mengisi formulir.</p>
                </div>
                ...
                <div class="relative overflow-hidden rounded-xl bg-slate-900 border border-slate-800 aspect-[16/10] flex items-center p-6 md:p-8 shadow-inner">
                    ...
                    <div class="absolute inset-0 z-0">
                        <img id="live-preview-bg" src="" class="w-full h-full object-cover brightness-[0.55] hidden">
                        <div id="live-preview-placeholder" class="absolute inset-0 flex flex-col items-center justify-center text-slate-500 bg-slate-950/90 border border-dashed border-slate-800 rounded-xl">
                            <svg class="w-10 h-10 text-slate-700 mb-2 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
