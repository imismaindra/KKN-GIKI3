...
@section('page_title', 'Tambah Ekstrakurikuler Baru')
...
<div class="max-w-2xl">
    ...
    <form action="{{ route('admin.extracurriculars.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm space-y-6">
        @csrf
        
        <div>
            <label for="name" class="block text-sm font-semibold text-slate-700 mb-1">Nama Ekstrakurikuler</label>
            <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus placeholder="Contoh: Futsal, Paduan Suara, PMR"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
                ...
                <select name="category" id="category" class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
                    ...
                    <option value="Kepanduan" {{ old('category') == 'Kepanduan' ? 'selected' : '' }}>Kepanduan</option>
                    <option value="Sosial & Kesehatan" {{ old('category') == 'Sosial & Kesehatan' ? 'selected' : '' }}>Sosial & Kesehatan</option>
            ...
            <div>
                ...
                <input type="text" name="pembina" id="pembina" value="{{ old('pembina') }}" placeholder="Contoh: Dra. Sri Utami / Coach Rudy"
                    class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
        ...
        <div>
            ...
            <input type="text" name="schedule" id="schedule" value="{{ old('schedule') }}" placeholder="Contoh: Sabtu, 08.00 - 10.00 WIB"
                class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
