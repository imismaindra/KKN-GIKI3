...
<div class="w-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm" class="lg:col-span-7 bg-white rounded-2xl border border-slate-100 p-6 md:p-8 shadow-sm space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="datetime-local" name="published_at" id="published_at" value="{{ old('published_at') }}"
                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
                    <p class="text-[10px] text-slate-400 mt-1">Biarkan kosong jika ingin otomatis dirilis langsung saat dipublikasikan.</p>
            ...
            <div>
                <label for="thumbnail" class="block text-sm font-semibold text-slate-700 mb-1">Gambar Cover / Thumbnail</label>
                ...
                <p class="text-[10px] text-slate-400 mt-1">Format gambar (JPG, PNG, WebP). Maksimal 2MB.</p>
            ...
            <div>
                ...
                <!-- Input tersembunyi untuk menampung HTML editor saat disubmit -->
            ...
            <div>
                ...
                <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="Judul khusus hasil pencarian (kosongkan untuk menyamakan dengan judul artikel)"
                    class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
            ...
            <div>
                ...
                <textarea name="meta_description" id="meta_description" rows="3" placeholder="Ringkasan pendek artikel yang memikat pembaca di Google..."
                    class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">{{ old('meta_description') }}</textarea>
            ...
            <div>
                ...
                <input type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="Contoh: berita sekolah, sma giki 3, pondok ramadhan"
                    class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-slate-800 transition duration-150">
            ...
            <div class="bg-white rounded-2xl border border-slate-100 overflow-hidden shadow-sm">
                ...
                <div id="previewArticle" class="block">
                    ...
                    <div class="relative w-full h-48 bg-slate-100 border-b border-slate-100 flex items-center justify-center overflow-hidden">
                        <img id="previewCover" src="" class="w-full h-full object-cover hidden" alt="Cover Preview">
                        <div id="previewCoverEmpty" class="text-center p-6 text-slate-400">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="prose prose-sm max-w-none text-slate-700 min-h-[120px] text-xs leading-relaxed border-t border-slate-50 pt-4" id="previewContent">
                            <p class="text-slate-400 italic">Konten artikel kosong. Ketik di editor untuk melihat pratinjau langsung...</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-1.5 font-sans">
                        ...
                        <div class="flex items-center space-x-2 text-xs">
                            ...
                            <div class="flex flex-col leading-tight">
                                ...
                                <span class="text-slate-400 text-[10px] truncate" id="googlePreviewUrl">https://smagiki3surabaya.sch.id/artikel/...</span>
                            </div>
                        </div>
                        ...
                        <p class="text-sm text-[#4d5156] leading-relaxed line-clamp-3" id="googlePreviewDesc">
                            Ringkasan deskripsi khusus hasil pencarian akan tampil di sini. Jika kosong, Google akan menampilkan potongan konten terformat dari isi artikel.
                        </p>
                    </div>
                </div>
            </div>
